...
import {
  ...
  increase,
  decrease,
} from "../../redux/store/launchesSlice";
...
function App() {
  ...
  if (error) {
    return <Alert message="Error" description="Sorry its error" type="error" />;
  }
  ...
  return (
    <div className="App">
      <header className="SpaceX launches">SpaceX launches</header>
